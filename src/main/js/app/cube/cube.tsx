    ...
    private renderCubeBoxes = () => {
        ...
        return <>
            <Middle colour1={colours[13]}
                    ...
                    rotationAxis={X_ROTATION.scale(-1)}
            />
            <Middle colour1={colours[4]}
                    position={new Vector3(-1, 0, 0)}
                    rotationAxis={Z_ROTATION}
            />
            <Middle colour1={colours[31]}
                    position={new Vector3(0, 0, 1)}
                    rotationAxis={X_ROTATION}
            />
            <Middle colour1={colours[22]}
                    position={new Vector3(1, 0, 0)}
                    rotationAxis={Z_ROTATION.scale(-1)}
            />
            ...
            <Middle colour1={colours[49]}
                    position={new Vector3(0, -1, 0)}
                    rotationAxis={X_ROTATION.scale(2)}
            />
            ...
            <Edge colour1={colours[37]}
                  colour2={colours[28]}
                  position={new Vector3(0, 1, 1)}
                  rotationAxis={Y_ROTATION.scale(2)}
            />
            <Edge colour1={colours[39]}
                  colour2={colours[1]}
                  position={new Vector3(-1, 1, 0)}
                  rotationAxis={Y_ROTATION}
            />
            <Edge colour1={colours[41]}
                  colour2={colours[19]}
                  position={new Vector3(1, 1, 0)}
                  rotationAxis={Y_ROTATION.scale(-1)}
            />
            <Edge colour1={colours[46]}
                  colour2={colours[16]}
                  position={new Vector3(0, -1, -1)}
                  rotationAxis={X_ROTATION.scale(2).add(Y_ROTATION.scale(2))}
            />
            ...
            <Edge colour1={colours[48]}
                  colour2={colours[7]}
                  position={new Vector3(-1, -1, 0)}
                  rotationAxis={X_ROTATION.scale(2).add(Y_ROTATION)}
            />
            <Edge colour1={colours[50]}
                  colour2={colours[25]}
                  position={new Vector3(1, -1, 0)}
                  rotationAxis={X_ROTATION.scale(2).add(Y_ROTATION.scale(-1))}
            />
            ...
            <Edge colour1={colours[3]}
                  colour2={colours[32]}
                  position={new Vector3(-1, 0, 1)}
                  rotationAxis={Y_ROTATION.scale(2).add(Z_ROTATION.scale(-1))}
            />
            <Edge colour1={colours[30]}
                  colour2={colours[23]}
                  position={new Vector3(1, 0, 1)}
                  rotationAxis={X_ROTATION.add(Y_ROTATION.scale(-1))}
            />
            ...
            <Corner colour1={colours[45]}
                    ...
                    colour3={colours[8]}
                    position={new Vector3(-1, -1, -1)}
                    rotationAxis={Z_ROTATION.scale(2)}
            />
            <Corner colour1={colours[38]}
                    colour2={colours[20]}
                    colour3={colours[27]}
                    position={new Vector3(1, 1, 1)}
                    rotationAxis={Y_ROTATION.scale(3)}
            />
            ...
            <Corner colour1={colours[35]}
                    ...
                    colour3={colours[6]}
                    position={new Vector3(-1, -1, 1)}
                    rotationAxis={Y_ROTATION.scale(2).add(X_ROTATION)}
            />
        </>
    };
}